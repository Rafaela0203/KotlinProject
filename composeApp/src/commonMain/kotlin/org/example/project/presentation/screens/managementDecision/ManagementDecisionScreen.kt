    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = {
                    Text(
                        text = "Decisão de manejo", // Título da TopAppBar
        ...
        content = { paddingValues ->
            Column(
                ...
                ScoreSection(
                    ...
                    iconTint = Color(0xFF4CAF50), // Green for good
                    backgroundColor = Color(0xFFE8F5E9) // Light green background
                )

                // Escores VESS entre 3 a 3,9
                ScoreSection(
                    ...
                    iconTint = Color(0xFFFFC107), // Amber for reasonable
                    backgroundColor = Color(0xFFFFF8E1) // Light amber background
                )

                // Escores VESS entre 4 a 5
                ScoreSection(
                    ...
                    iconTint = Color(0xFFF44336), // Red for poor
                ...
                modifier = Modifier.fillMaxWidth().wrapContentWidth(Alignment.End) // Alinha à direita
                )
    ...
    Column(
        ...
        Row(
            ...
            Text(
                ...
                fontWeight = FontWeight.Bold,
                color = LightColorScheme.onBackground // Usar cor que contraste com o background da seção
            )
        }
        Text(
            text = description,
